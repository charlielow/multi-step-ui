...
},{"react":23,"react-dom":20}],3:[function(require,module,exports){
"use strict";
...
},{"react":23,"react-dom":20}],5:[function(require,module,exports){
"use strict";
...
},{"../components/Debug":2,"../components/Tree":4,"react":23,"react-dom":20}],8:[function(require,module,exports){
"use strict";
...
},{"../../../src/multi-step-ui":30,"../../data/sign-up-flow-react.json":1,"./import/sign-up-flow-react/forks":6,"./import/sign-up-flow-react/render":7,"./import/sign-up-flow-react/steps":8,"./import/util/autoPlay":9}],13:[function(require,module,exports){
(function (global){
/**
...
},{"./cjs/scheduler-tracing.development.js":24,"./cjs/scheduler-tracing.production.min.js":25,"_process":15}],30:[function(require,module,exports){
"use strict";
        ...
        branch.forEach(function (n, i, list) {
          if (n.type === 'fork') {
            ...
            try {
              ...
              fork = (0, _lodash.default)(_this.forks[n.id]);
            } catch (err) {
              /* do nothing */
            }

            fork = fork || {}; // Mix in any config properties, namely id
            ...
            Object.entries(fork.branches).forEach(function (_ref) {
            ...
            step = step || {}; // Step needs to be the destination so it can retain
            // its prototype chain, n is just a plain JSON config

            Object.assign(step, n);
            step.type = 'step';
            step.uniqueId = step.id + count; // If the current step is the last item in its branch
            // then it is a leaf
...
},{"./util":31,"lodash.clonedeep":13}],31:[function(require,module,exports){
"use strict";
