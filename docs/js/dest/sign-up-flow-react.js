...
},{"react":22,"react-dom":19}],3:[function(require,module,exports){
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, "React component step: ", tree.getTreeState().currentStepUniqueId, " ");
    }
  }]);
...
function (_React$Component) {
  ...
  _createClass(Tree, [{
    ...
    value: function render() {
      ...
      var mapBranch = function mapBranch(branch) {
        return branch.map(function (n) {
          if (n.type === 'step') {
            var liClassName = n.isLeaf === true ? 'is-leaf' : '';
            var iconClassName = n.isLeaf === true ? 'fas fa-leaf' : 'far fa-stop-circle';
            return _react.default.createElement("li", {
              key: n.uniqueId,
              className: liClassName + (n.uniqueId === tree.getTreeState().currentStepUniqueId ? ' selected' : '')
            ...
            return _react.default.createElement("li", {
              key: n.uniqueId
            }, _react.default.createElement("ul", null, Object.keys(n.branches).map(function (branch) {
              return _react.default.createElement("li", {
                key: branch
              }, _react.default.createElement("div", null, _react.default.createElement("i", {
                className: "fas fa-code-branch"
              }), " ", branch, _react.default.createElement("ul", null, mapBranch(n.branches[branch]))));
            })));
          }
        });
      };

      return _react.default.createElement("div", null, _react.default.createElement("ul", null, mapBranch(tree.config)));
    }
  }]);
...
},{"react":22,"react-dom":19}],5:[function(require,module,exports){
"use strict";
...
},{"react":22}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forks = void 0;

var _forks = require("../util/forks");

var forks = {
  buyerOrSeller: _forks.spinTheBottle,
  freeOrPaid: _forks.spinTheBottle,
  tShirtUpsell: _forks.spinTheBottle,
  tShirtUpsellAlreadyPaid: _forks.spinTheBottle
};
exports.forks = forks;

},{"../util/forks":10}],7:[function(require,module,exports){
"use strict";
...
var _Debug = _interopRequireDefault(require("../components/Debug"));
...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    key: "render",
    value: function render() {
      var tree = this.props.tree; // Save reference to the return value of the current step's render method
      // This may be a react component or it may be a string

      var stepRender = tree.getStepByUniqueId(tree.getTreeState().currentStepUniqueId).renderStep({
        tree: tree
      });
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        className: "card"
        ...
        className: "card-body"
      }, _react.default.createElement("form", null, typeof stepRender === 'function' ? _react.default.createElement(stepRender, {
        tree: tree
...
function (_React$Component2) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement("b", null, tree.getTreeState().currentStepUniqueId), _react.default.createElement(NavHeader, {
        tree: tree
      })));
    }
  }]);
...
function (_React$Component4) {
  ...
  _createClass(Footer, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(NavFooter, {
        tree: tree
      })));
    }
  }]);
...
function (_React$Component5) {
  _inherits(NavFooter, _React$Component5);

  function NavFooter() {
    _classCallCheck(this, NavFooter);

    return _possibleConstructorReturn(this, _getPrototypeOf(NavFooter).apply(this, arguments));
  }

  _createClass(NavFooter, [{
    key: "render",
    value: function render() {
      var tree = this.props.tree;
...
var render = function render() {
  ...
  _reactDom.default.render(_react.default.createElement(Layout, {
    tree: this
  }), document.getElementById('render'));

  _reactDom.default.render(_react.default.createElement(_Debug.default, {
    tree: this
...
},{"../components/Debug":2,"../components/Tree":4,"react":22,"react-dom":19}],8:[function(require,module,exports){
"use strict";
...
var _steps = require("../util/steps");

var _CreateAccount = require("./components/CreateAccount");
...
var steps = {
  ...
  // Generic past here
  addInventory: _steps.genericStep,
  congrats: _steps.genericStep,
  primaryObjective: _steps.genericStep,
  profileAddress: _steps.genericStep,
  profileBankInfo: _steps.genericStep,
  profileBasic: _steps.genericStep,
  profileCreditCard: _steps.genericStep,
  profilePhoto: _steps.genericStep,
  reviewCart: _steps.genericStep,
  subscribe: _steps.genericStep,
  upsellTShirt: _steps.genericStep
};
exports.steps = steps;

},{"../util/steps":11,"./components/CreateAccount":5}],9:[function(require,module,exports){
"use strict";
...
/**
 * Placeholder generic step for steps yet to be defined
 */
var genericStep = {
  renderStep: function renderStep() {
    return _Step.Step;
...
},{"../components/Step":3}],12:[function(require,module,exports){
"use strict";

var _multiStepUi = require("../../../src/multi-step-ui");

var _steps = require("./import/sign-up-flow-react/steps");

var _forks = require("./import/sign-up-flow-react/forks");

var _render = require("./import/sign-up-flow-react/render");
...
var config = require('../../data/sign-up-flow-react.json');
...
},{"../../../src/multi-step-ui":29,"../../data/sign-up-flow-react.json":1,"./import/sign-up-flow-react/forks":6,"./import/sign-up-flow-react/render":7,"./import/sign-up-flow-react/steps":8,"./import/util/autoPlay":9}],13:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"_process":14,"object-assign":13,"prop-types/checkPropTypes":15,"react":22,"scheduler":27,"scheduler/tracing":28}],18:[function(require,module,exports){
/** @license React v16.6.0
...
},{"object-assign":13,"react":22,"scheduler":27}],19:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react-dom.development.js":17,"./cjs/react-dom.production.min.js":18,"_process":14}],20:[function(require,module,exports){
(function (process){
/** @license React v16.6.0
...
},{"_process":14,"object-assign":13,"prop-types/checkPropTypes":15}],21:[function(require,module,exports){
/** @license React v16.6.0
...
},{"object-assign":13}],22:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":20,"./cjs/react.production.min.js":21,"_process":14}],23:[function(require,module,exports){
(function (process){
/** @license React v16.6.0
...
},{"./cjs/scheduler.development.js":25,"./cjs/scheduler.production.min.js":26,"_process":14}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/scheduler-tracing.development.js":23,"./cjs/scheduler-tracing.production.min.js":24,"_process":14}],29:[function(require,module,exports){
"use strict";
