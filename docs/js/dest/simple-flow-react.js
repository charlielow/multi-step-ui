...
},{"react":19,"react-dom":16}],3:[function(require,module,exports){
"use strict";
...
function (_React$Component) {
  ...
  _createClass(StepTwo, [{
    ...
    value: function render() {
      ...
      var setStateRadio = function setStateRadio(evt) {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        id: "buyer",
        value: "buyer",
        checked: tree.store.memberType === 'buyer',
        name: "memberType",
        ...
        htmlFor: "buyer"
      }, "Search marketplace")), _react.default.createElement("div", {
        className: "custom-control custom-radio"
      }, _react.default.createElement("input", {
        type: "radio",
        id: "seller",
        value: "seller",
        checked: tree.store.memberType === 'seller',
        name: "memberType",
        className: "custom-control-input",
        onChange: setStateRadio
      }), _react.default.createElement("label", {
...
var forks = {
  forkOne: {
    getNextBranch: function getNextBranch(props) {
      var tree = props.tree;
...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      var step = tree.getStepByUniqueId(tree.getTreeState().currentStepUniqueId).renderStep({
        tree: tree
      });
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        className: "card"
        ...
        className: "card-body"
      }, typeof step === 'function' ? _react.default.createElement(step, {
        tree: tree
...
function (_React$Component2) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      var tree = this.props.tree;
      var uniqueId = tree.getTreeState().currentStepUniqueId;
      var heading = tree.getStepByUniqueId(uniqueId).heading;
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        className: "card-header text-center"
      }, _react.default.createElement("b", null, heading || uniqueId), _react.default.createElement(NavHeader, {
        tree: tree
      })));
    }
  }]);
...
function (_React$Component3) {
  ...
  _createClass(NavHeader, [{
    ...
    value: function render() {
      var tree = this.props.tree;
      var step = tree.getStepByUniqueId(tree.getTreeState().currentStepUniqueId);
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        className: "btn-back"
      ...
      }))), !step.hideSubmit && _react.default.createElement("div", {
...
function (_React$Component5) {
  ...
  _createClass(NavFooter, [{
    ...
    value: function render() {
      var tree = this.props.tree;
      var step = tree.getStepByUniqueId(tree.getTreeState().currentStepUniqueId);
      return _react.default.createElement("div", null, !step.hideSubmit && _react.default.createElement("button", {
        type: "submit",
...
var render = function render() {
  ...
  _reactDom.default.render(_react.default.createElement(Layout, {
    tree: this
  }), document.getElementById('render'), function () {
    // A way to execute logic after rendering a simple string render step
    var postRender = this.getStepByUniqueId(this._treeState.currentStepUniqueId).postRender;
...
},{"../components/Debug":2,"../components/Tree":3,"react":19,"react-dom":16}],8:[function(require,module,exports){
"use strict";
...
var _StepTwo = require("./components/StepTwo");

var congrats = {
  renderStep: function renderStep(props) {
    var tree = props.tree;
    var name = tree.store.name;
    var memberType = tree.store.memberType;
    return "\n      <div class=\"text-center h5 m-4\">\n        <i class=\"far fa-grin\"></i>\n        <b>Congrats on signing up as a <i>".concat(memberType, "</i><br> ").concat(name, "!</b>\n      </div>\n      <div class=\"text-center h5 m-4\">\n        <button type=\"button\" class=\"btn btn-secondary\" id=\"onward\">Onward!</button>\n      </div>\n    ");
  },
  postRender: function postRender(props) {
    var tree = props.tree;
...
var _steps = require("./import/simple-flow-react/steps");

var _forks = require("./import/simple-flow-react/forks");
...
},{"../../../src/multi-step-ui":26,"../../data/simple-flow-react.json":1,"./import/simple-flow-react/forks":6,"./import/simple-flow-react/render":7,"./import/simple-flow-react/steps":8}],10:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
