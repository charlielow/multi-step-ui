...
class CreateAccount extends React.Component {
  render () {
    ...
    let isFastForwarding = tree.getTreeState().isFastForwarding;
      ...
      <div>
        <div className="form-group">
          ...
          <div className="invalid-feedback">
            {!isFastForwarding && tree.store.errors && tree.store.errors.name}            
          </div>
        </div>
        <div className="form-group">
          ...
          <div className="invalid-feedback">
            {!isFastForwarding && tree.store.errors && tree.store.errors.email}            
          </div>
        </div>
        <div className="form-group">
